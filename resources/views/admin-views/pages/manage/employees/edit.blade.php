...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    @include('admin-views.partials.content-header',['pageParent' => 'Quản lý Nhân viên', 'pageName' => 'Sửa Nhân viên'])
                    ...
                    <form action="{{route('employees.update',['id' => $employee->id ])}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group input-group-merge speech-to-text">
                                    <input type="text" name="name" value="{{$employee->name}}" class="form-control" placeholder="Nhập hoặc nói Họ và tên" aria-describedby="text-to-speech-addon" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="input-group input-group-merge speech-to-text">
                                    <input type="number" min="0" name="salary_per_month" value="{{$employee->salary_per_month}}" class="form-control" placeholder="Nhập hoặc nói lương tháng" aria-describedby="text-to-speech-addon" required>
                                    <span class="input-group-text" id="text-to-speech-addon">
                                        <i class="bx bx-microphone cursor-pointer text-to-speech-toggle"></i>
                                    </span>
                                </div>
