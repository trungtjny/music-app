...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    @include('admin-views.partials.content-header',['pageParent' => 'Quản lý Khách hàng', 'pageName' => 'Sửa Khách hàng'])
                    ...
                    <form action="{{route('customers.update',['id' => $customer->id ])}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group input-group-merge speech-to-text">
                                    <input type="text" name="name" value="{{$customer->name}}" class="form-control" placeholder="Nhập hoặc nói Họ và tên" aria-describedby="text-to-speech-addon" required>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group input-group-merge speech-to-text">
                                    <input type="email" name="email" value="{{$customer->email}}" class="form-control" placeholder="Nhập hoặc nói email" aria-describedby="text-to-speech-addon" required>
                                    <span class="input-group-text" id="text-to-speech-addon">
                                        <i class="bx bx-microphone cursor-pointer text-to-speech-toggle"></i>
                                    </span>
                                </div>
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-password-toggle">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="password" class="form-control" name="password" value="{{$customer->password}}" id="basic-default-password32" placeholder="············" aria-describedby="basic-default-password">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="input-group input-group-merge speech-to-text">
                                    <input type="number" min="0" name="coin" value="{{$customer->coin}}" class="form-control" placeholder="Nhập hoặc nói lương tháng" aria-describedby="text-to-speech-addon" required>
                                    <span class="input-group-text" id="text-to-speech-addon">
                                        <i class="bx bx-microphone cursor-pointer text-to-speech-toggle"></i>
                                    </span>
                                </div>
