...
@section('admin-title')
<title>Thêm mới danh mục Bài hát</title>
@endsection
...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    @include('admin-views.partials.content-header',['pageParent' => 'Quản lý danh mục sản phẩm', 'pageName' => 'Thêm mới danh mục'])
        ...
        <div class="col-lg">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between my-2">
                    <div class="p-2">
                        <h5 class="card-title mb-0">Thêm mới danh mục bài hát</h5>
                    </div>
                    <!-- <div class="pt-md-0">
