...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    @include('admin-views.partials.content-header',['pageParent' => 'Quản lý Nghệ sĩ', 'pageName' => 'Sửa Nghệ sĩ'])
        ...
        <div class="col-lg">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between my-2">
                    <div class="p-2">
                        <h5 class="card-title mb-0">Sửa Nghệ sĩ</h5>
                    </div>
                    <!-- <div class="pt-md-0">
                    ...
                    <form action="{{route('artists.update',['id' => $artist->id ])}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="input-group input-group-merge speech-to-text">
                                    <input type="number" min="0" name="coin" value="{{$artist->coin}}" class="form-control" placeholder="Nhập hoặc nói lương tháng" aria-describedby="text-to-speech-addon" required>
                                    <span class="input-group-text" id="text-to-speech-addon">
                                        <i class="bx bx-microphone cursor-pointer text-to-speech-toggle"></i>
                                    </span>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="">
                                    ...
                                    @if (isset($artist->id_card_front))
                                    <img class="avatar2 my-3 img-custom" width="250" height="200" src="{{ $artist->id_card_front }}">
                                    @else
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="">
                                    ...
                                    @if (isset($artist->id_card_back))
                                    <img class="avatar3 my-3 img-custom" width="250" height="200" src="{{ $artist->id_card_back }}">
                                    @else
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control tinymce-editor" name="description" id="exampleFormControlTextarea1" rows="25">{{$artist->description}}</textarea>
                        </div>
