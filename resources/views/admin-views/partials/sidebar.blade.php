    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">SGM Music</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item open">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item {{ request()->is('*admin/artists*') ? 'active' : '' }}">
                  <a href="{{route('artists.index')}}" class="menu-link">
                    <div data-i18n="Carousel">Quản lý Nghệ sĩ</div>
                  </a>
                </li>
